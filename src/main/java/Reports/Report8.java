 ...
 * @author user-ubunto
 */
public class Report8 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Report8
     */
    public Report8(ControlDB control1,String date1, String date2, String codeStore) {
        initComponents();
        this.control = control1;
        this.dtmProduct = (DefaultTableModel)this.TableProduct.getModel();        
        ArrayList<String> codeProducts = control1.codesReport8(date1,date2,codeStore);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de los productos más vendidos por tienda en un intervalo de tiempo.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        products.exportReport("Listado de los productos más vendidos por tienda en un intervalo de tiempo.");
