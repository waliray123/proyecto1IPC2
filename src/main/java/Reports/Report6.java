 ...
 * @author user-ubunto
 */
public class Report6 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Report6
     */
    public Report6(ControlDB control1,String clientNIT) {
        initComponents();        
        this.control = control1;
        this.dtmOrder = (DefaultTableModel)this.jTable1.getModel();
        this.orders = control1.setReport6(clientNIT);
        setProductsTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de todos los pedidos en curso de un cliente.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        export.exportReport("Listado de todos los pedidos en curso de un cliente.");
