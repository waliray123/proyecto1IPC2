...
public class Report3 extends javax.swing.JFrame {
     ...
     */
    public Report3(ControlDB control1, String codeStore) {
        initComponents();
        this.control = control1;
        this.dtmOrder = (DefaultTableModel)this.jTable1.getModel();
        this.orders = control1.setReport3(codeStore);
        setProductsTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de todos los pedidos atrasados que llegarán a la tienda.");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        export.exportReport("Listado de todos los pedidos atrasados que llegarán a la tienda.");
